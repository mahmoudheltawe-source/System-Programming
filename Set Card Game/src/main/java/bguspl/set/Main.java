...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        if (ui == null && config.humanPlayers > 0) {
            System.out.println("Cannot open the game window: no graphical display is available.");
            System.out.println("Run from a desktop terminal/X11 session, or set HumanPlayers=0 and ComputerPlayers>0 for a headless AI test.");
